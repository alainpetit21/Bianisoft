...
public final class SpriteOneTimer extends Sprite{
	public SpriteOneTimer(String p_stResImage, int p_nNbFrame, double p_fSpeed){
		super(p_stResImage);
		addState(new State(p_stResImage, p_nNbFrame, p_fSpeed));
	}
