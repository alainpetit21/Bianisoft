	...
	public void get_audio( short[] output, int offset, int count ) {
		...
		while( count > 0 ) {
			if( mix_pos >= mix_len ) {
				...
				mix_pos = 0;
				mix_len = downsample( mix_buf, replay.getAudio( mix_buf ) );
			}
